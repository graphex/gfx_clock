...
readonly TARGET_HOST=pi@192.168.168.202
...
readonly SOURCE_SERVICE=./service/gfx_clock.service
...
# put the /service/gfx_clock.service in the pi's /lib/systemd/system/ dir
